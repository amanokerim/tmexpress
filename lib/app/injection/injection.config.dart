...
import '../../domain/usecases/order/fetch_orders_usecase.dart' as _i64;
import '../../domain/usecases/order/fetch_shipping_options.dart' as _i67;
import '../../domain/usecases/order/get_placed_order.dart' as _i70;
...
import '../../domain/usecases/products/fetch_brands_usecase.dart' as _i59;
import '../../domain/usecases/products/fetch_categories_usecase.dart' as _i60;
import '../../domain/usecases/products/fetch_favorite_products_usecase.dart'
    as _i61;
import '../../domain/usecases/products/fetch_home_usecase.dart' as _i62;
import '../../domain/usecases/products/fetch_hot_products.dart' as _i63;
import '../../domain/usecases/products/fetch_product_usecase.dart' as _i65;
import '../../domain/usecases/products/fetch_products_usecase.dart' as _i66;
import '../../domain/usecases/products/fetch_subcategory_sizes.dart' as _i68;
import '../../domain/usecases/products/like_product_usecase.dart' as _i73;
...
import '../../presentation/screens/auth_2/bloc/auth_bloc.dart' as _i56;
import '../../presentation/screens/cart/bloc/cart_bloc.dart' as _i80;
import '../../presentation/screens/category/bloc/brands_bloc.dart' as _i79;
import '../../presentation/screens/category/bloc/category_bloc.dart' as _i81;
import '../../presentation/screens/detail/bloc/detail_bloc.dart' as _i82;
import '../../presentation/screens/home/bloc/home_bloc.dart' as _i71;
import '../../presentation/screens/home/search/bloc/search_bloc.dart' as _i77;
import '../../presentation/screens/hot/bloc/hot_bloc.dart' as _i72;
...
import '../../presentation/screens/products/bloc/filter/filter_bloc.dart'
    as _i69;
import '../../presentation/screens/products/bloc/products_bloc.dart' as _i76;
...
import 'register_module.dart' as _i83;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i44.AuthBloc>(
        () => _i44.AuthBloc(gh<_i40.ProfileRepository>()));
    gh.lazySingleton<_i45.AuthUseCase>(
        () => _i45.AuthUseCase(gh<_i40.ProfileRepository>()));
    gh.lazySingleton<_i46.CategoryResponseMapper>(
        () => _i46.CategoryResponseMapper(gh<_i33.GroupResponseMapper>()));
    gh.lazySingleton<_i47.EditProfileUseCase>(
        () => _i47.EditProfileUseCase(gh<_i40.ProfileRepository>()));
    gh.lazySingleton<_i48.FetchProfileUseCase>(
        () => _i48.FetchProfileUseCase(gh<_i40.ProfileRepository>()));
    ...
    gh.lazySingleton<_i59.FetchBrandsUseCase>(
        () => _i59.FetchBrandsUseCase(gh<_i51.ProductRepository>()));
    gh.lazySingleton<_i60.FetchCategoriesUseCase>(
        () => _i60.FetchCategoriesUseCase(gh<_i51.ProductRepository>()));
    gh.lazySingleton<_i61.FetchFavoriteProductsUseCase>(
        () => _i61.FetchFavoriteProductsUseCase(gh<_i51.ProductRepository>()));
    gh.lazySingleton<_i62.FetchHomeUseCase>(
        () => _i62.FetchHomeUseCase(gh<_i51.ProductRepository>()));
    gh.lazySingleton<_i63.FetchHotProducts>(
        () => _i63.FetchHotProducts(gh<_i51.ProductRepository>()));
    gh.lazySingleton<_i64.FetchPlacedOrdersUseCase>(
        () => _i64.FetchPlacedOrdersUseCase(gh<_i49.OrderRepository>()));
    gh.lazySingleton<_i65.FetchProductUseCase>(
        () => _i65.FetchProductUseCase(gh<_i51.ProductRepository>()));
    gh.lazySingleton<_i66.FetchProductsUseCase>(
        () => _i66.FetchProductsUseCase(gh<_i51.ProductRepository>()));
    gh.lazySingleton<_i67.FetchShippingOptions>(
        () => _i67.FetchShippingOptions(gh<_i49.OrderRepository>()));
    gh.lazySingleton<_i68.FetchSubcategorySizesUseCase>(
        () => _i68.FetchSubcategorySizesUseCase(gh<_i51.ProductRepository>()));
    gh.factory<_i69.FilterBloc>(
        () => _i69.FilterBloc(gh<_i68.FetchSubcategorySizesUseCase>()));
    gh.lazySingleton<_i70.GetPlacedOrderUseCase>(
        () => _i70.GetPlacedOrderUseCase(gh<_i49.OrderRepository>()));
    gh.factory<_i71.HomeBloc>(() => _i71.HomeBloc(gh<_i62.FetchHomeUseCase>()));
    gh.factory<_i72.HotBloc>(
        () => _i72.HotBloc(gh<_i54.SearchProductsUseCase>()));
    gh.lazySingleton<_i73.LikeProductUseCase>(
        () => _i73.LikeProductUseCase(gh<_i51.ProductRepository>()));
    gh.factory<_i74.PlacedOrderBloc>(
        () => _i74.PlacedOrderBloc(gh<_i70.GetPlacedOrderUseCase>()));
    gh.factory<_i75.PlacedOrdersBloc>(
        () => _i75.PlacedOrdersBloc(gh<_i64.FetchPlacedOrdersUseCase>()));
    gh.factory<_i76.ProductsBloc>(
        () => _i76.ProductsBloc(gh<_i66.FetchProductsUseCase>()));
    gh.factory<_i77.SearchBloc>(
        () => _i77.SearchBloc(gh<_i54.SearchProductsUseCase>()));
    gh.factory<_i78.ShippingOptionsBloc>(
        () => _i78.ShippingOptionsBloc(gh<_i67.FetchShippingOptions>()));
    gh.factory<_i79.BrandsBloc>(
        () => _i79.BrandsBloc(gh<_i59.FetchBrandsUseCase>()));
    gh.factory<_i80.CartBloc>(
        () => _i80.CartBloc(gh<_i57.CreateOrderUseCase>()));
    gh.factory<_i81.CategoryBloc>(
        () => _i81.CategoryBloc(gh<_i60.FetchCategoriesUseCase>()));
    gh.factory<_i82.DetailBloc>(() => _i82.DetailBloc(
          gh<_i65.FetchProductUseCase>(),
          gh<_i73.LikeProductUseCase>(),
        ));
    return this;
  }
}
