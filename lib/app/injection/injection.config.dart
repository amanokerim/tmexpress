...
import '../../domain/usecases/products/fetch_product_usecase.dart' as _i47;
import '../../domain/usecases/products/fetch_products_usecase.dart' as _i48;
import '../../domain/usecases/products/like_product_usecase.dart' as _i50;
...
import '../../presentation/screens/category/bloc/category_bloc.dart' as _i52;
import '../../presentation/screens/detail/bloc/detail_bloc.dart' as _i53;
import '../../presentation/screens/home/bloc/home_bloc.dart' as _i49;
import '../../presentation/screens/main/bloc/main_bloc.dart' as _i10;
import '../../presentation/screens/products/bloc/products_bloc.dart' as _i51;
...
import 'register_module.dart' as _i54; // ignore_for_file: unnecessary_lambdas
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i47.FetchProductUseCase>(
      () => _i47.FetchProductUseCase(get<_i39.ProductRepository>()));
  gh.lazySingleton<_i48.FetchProductsUseCase>(
      () => _i48.FetchProductsUseCase(get<_i39.ProductRepository>()));
  gh.factory<_i49.HomeBloc>(() => _i49.HomeBloc(get<_i46.FetchHomeUseCase>()));
  gh.lazySingleton<_i50.LikeProductUseCase>(
      () => _i50.LikeProductUseCase(get<_i39.ProductRepository>()));
  gh.factory<_i51.ProductsBloc>(
      () => _i51.ProductsBloc(get<_i48.FetchProductsUseCase>()));
  gh.factory<_i52.CategoryBloc>(
      () => _i52.CategoryBloc(get<_i45.FetchCategoriesUseCase>()));
  gh.factory<_i53.DetailBloc>(() => _i53.DetailBloc(
      get<_i47.FetchProductUseCase>(),
      get<_i50.LikeProductUseCase>(),
