  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        focusedErrorBorder: AppInputBorder.custom(AppColors.secondary),
        errorBorder: AppInputBorder.custom(AppColors.secondary),
        errorStyle: AppTextStyle.dark12.copyWith(color: AppColors.secondary),
        counterText: '',
